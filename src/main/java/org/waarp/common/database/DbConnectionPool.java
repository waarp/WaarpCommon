...
public class DbConnectionPool {
	 ...
	 * are already in use, the method waits until a connection becomes available or
	 * <code>timeout</code> seconds elapsed. When the application is finished using the connection,
	...
	/**
	 * Returns the number of active (open) connections of this pool. This is the number of
	 * <code>Connection</code> objects that have been issued by {@link #getConnection()} for which
