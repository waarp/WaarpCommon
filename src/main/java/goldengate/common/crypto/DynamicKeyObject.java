...
public class DynamicKeyObject extends KeyObject {
     ...
     * (non-Javadoc)
     * 
     * @see goldengate.common.crypto.KeyObject#getAlgorithm()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see goldengate.common.crypto.KeyObject#getInstance()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see goldengate.common.crypto.KeyObject#getKeySize()
     */
    @Override
