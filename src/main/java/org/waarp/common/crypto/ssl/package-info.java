 ...
 * WaarpSslContextFactory ggSslContextFactory = new WaarpSslContextFactory(ggSecureKeyStore, <b>false</b>);</li>
 ...
 * Note: needClientAuthent is True if the TrustStore is used to authenticate Clients, False if only to authenticate Servers<li>
 * <li>Create the WaarpSslContextFactory:<br>
 * WaarpSslContextFactory ggSslContextFactory = new WaarpSslContextFactory(ggSecureKeyStore, <b>true</b>);</li>
 * <li>Create your own PipelineFactory:<br>
 * As first item in the pipeline, add:<br>
