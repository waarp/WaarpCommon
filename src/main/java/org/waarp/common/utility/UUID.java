 ...
 * <br>
 * Inspired from com.groupon locality-uuid which used combination of internal counter value -
 * process id - fragment of MAC address and Timestamp. see
...
public final class UUID {
    ...
    /**
     * Up to the 6 first bytes will be used. If Null or less than 6 bytes, extra bytes will be
     * randomly generated.
     * 
     * @param mac
    ...
    /**
     * Constructor that generates a new UUID using the current process id, MAC address, and
     * timestamp
     */
    public UUID() {
    ...
    /**
     * extract MAC address fragment from raw UUID bytes, setting missing values to 0, thus the first
     * half byte will be 0, followed by 7 and half bytes of the active MAC address when the UUID was
     * generated
     * 
